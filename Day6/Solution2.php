...
//Check to see if the new input is in our array of past states
//If it is, exit the calculation loop and calculate the
//difference between the first and second occurence of the
//repeated state 
...
for($i=0;$i<count($states);$i++){
	if($states[$i] === $states[$redistributions]){
		echo ($redistributions-$i);
		break;
	}
}
